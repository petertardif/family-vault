...
import FamilyMemberNav from './FamilyMemberNav'

describe(`FamilyMemberNav component`, () => {
  // const props = {u
  //   notes: [
  //     {
  ...
  it('renders a .FamilyMemberNav by default', () => {
    const wrapper = shallow(<FamilyMemberNav />)
